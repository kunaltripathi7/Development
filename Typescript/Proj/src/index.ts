...
const input = document.getElementById("todoinput") as HTMLInputElement; // cuz ts can't read html & know its an input ele
...
// form.addEventListener("submit", function(e) { // knows in context that e is a submitEvent
//     e.preventDefault();
//     console.log("submit")
// })
interface todo {
...
function createTodo(obj: todo): void {
